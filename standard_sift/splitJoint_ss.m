function OutPicture = splitJoint_ss(img1 ,img2 ,H)
% function : 中位插值 ,调用加权融合inosculate_weighted
% param img1 & img2:
% param H : 单应性矩阵
% return : 
  ...
  % set = max(offset)-min(offset);
    ...
    OutPicture = inosculate_weighted(change_picture_pad,change_picture,offset,c);
